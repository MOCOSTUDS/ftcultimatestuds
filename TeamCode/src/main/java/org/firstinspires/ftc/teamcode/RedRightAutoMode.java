...
@TeleOp(name = "Red Right Auto")
public class RedRightAutoMode extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        while (opModeIsActive()) {
            ...
            */
            ...
            //studbot.simpleMove(10, 10, -90);//-90

            //studbot.pivotAndElevate(180,3670);//0
            //studbot.simpleMove(10, 30, 0);



            studbot.simpleTankMoveHoriz (95, -1, -90);

            //studbot.ppMove (6,107,-90);

            //Thread.sleep(5000);

            studbot.pivotAndElevateFast(-45,3670);
            ...
            */
            ...
            studbot.pivotAndElevate(-5,3830);
            studbot.getShooter().setClawShoot();
            Thread.sleep(1500);
            studbot.getShooter().setClawOpen();
            Thread.sleep(1000);
