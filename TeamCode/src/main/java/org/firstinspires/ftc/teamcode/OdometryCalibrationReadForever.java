 ...
 */
@TeleOp(name = "Odometry System Calibration1", group = "Calibration")
public class OdometryCalibrationReadForever extends LinearOpMode {
    //Drive motors
    DcMotor right_front, right_back, left_front, left_back;
    //Odometry Wheels
    DcMotor verticalLeft, verticalRight, horizontalLeft, horizontalRight;
    ...
    public void runOpMode() throws InterruptedException {
        ...
        initHardwareMap(rfName, rbName, lfName, lbName, verticalLeftEncoderName,
                verticalRightEncoderName, horizontalLeftEncoderName, horizontalRightEncoderName);
       ...
       */
        ...
        double horizontal = (horizontalLeft.getCurrentPosition()+horizontalRight.getCurrentPosition())/2;

        horizontalTickOffset = horizontal/Math.toRadians(getZAngle());
    ...
    private void initHardwareMap(String rfName, String rbName, String lfName,
                                 String lbName, String vlEncoderName, String vrEncoderName,
                                 String hlEncoderName, String hrEncoderName){
        ...
        horizontalRight = hardwareMap.dcMotor.get(hrEncoderName);
        horizontalLeft = hardwareMap.dcMotor.get(hlEncoderName);
